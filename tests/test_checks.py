...
def test_no_errors_when_triggers_in_correct_location():
    assert check_triggers_not_in_constraints() == []


@pytest.mark.django_db
def test_error_when_trigger_in_constraints():
    fake = UniqueConstraintTrigger(fields=["slug"], name="misplaced_trigger")
